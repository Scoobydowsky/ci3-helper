...
class Ci3StubIncludePathContributor : PhpIncludedPathsContributor {
    ...
    override fun getRoots(project: Project): Collection<VirtualFile> {
        ...
        val stubNames = listOf(
            "CI_Controller.php", "MY_Controller.php", "global_functions.php", "array_helper.php",
            ...
            "CI_Encrypt.php", "CI_Encryption.php", "CI_Ftp.php", "CI_Cart.php",
            "CI_Email.php", "CI_Typography.php", "CI_Migration.php"
        )
